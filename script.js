...
async function rechercherEnDirect() {
    ...
    try {
        ...
        data.results.slice(0, 8).forEach(film => {
            ...
            item.innerHTML = `<img src="https://image.tmdb.org/t/p/w92${film.poster_path}"><div>${film.title}</div>`;
...
function ouvrirModal(id) {
    ...
    if (m.videoUrl) {
        ...
        playSection.innerHTML = `<p style="text-align:center; color:#888;">Aucun lien vidéo trouvé.</p>`;
    }
